...
require('lazy').setup({
  ...
  --
  -- NOTE: Git integration (gitsigns) is configured in kickstart/plugins/gitsigns.lua
  -- See that file for signs configuration and all git-related keymaps
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        clangd = {}, -- already had this (C/C++)
        -- gopls = {},            -- optional (Go)
        -- pyright = {},         -- optional (Python)
        -- rust_analyzer = {},   -- optional (Rust)

        ts_ls = {},
        tailwindcss = {}, -- 🆕 for Tailwind class autocomplete
        html = {}, -- 🆕 for HTML tag support
        cssls = {}, -- 🆕 for regular CSS support
